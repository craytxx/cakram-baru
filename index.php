                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="barang.php"><i class="fa-solid fa-box"></i> Daftar Barang</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="riwayat.php"><i class="fa-solid fa-folder"></i> Riwayat Barang</a></li>
